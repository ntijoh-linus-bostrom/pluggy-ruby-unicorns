defmodule Mix.Tasks.Seed do
  ...
  defp seed_data() do
    ...
    Postgrex.query!(DB, "INSERT INTO pizzas(name, ingredients, image) VALUES($1, $2, $3)", ["Prosciuttio e funghi", 16524, "prosciuttio-e-funghi.svg"], pool: DBConnection.ConnectionPool)
